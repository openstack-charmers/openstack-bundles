...
*DEV/TEST ONLY*: This unstable, development example bundle deploys a Ceph (Jewel) cluster on Ubuntu 16.04 LTS. See also: [Stable Bundles](https://jujucharms.com/u/openstack-charmers).
