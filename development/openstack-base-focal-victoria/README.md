...
*DEV/TEST ONLY*: This unstable, development example bundle deploys a basic OpenStack Cloud (Victoria with Ceph Octopus) on Ubuntu 20.04 LTS (Focal), providing Dashboard, Compute, Network, Block Storage, Object Storage, Identity and Image services.  See also: [Stable Bundles](https://jujucharms.com/u/openstack-charmers).
