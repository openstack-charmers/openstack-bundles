# OpenStack Charms: a Pike Cloud for Refstack Testing

This bundle is not HA, not for production use.  It is for validating refstack tests on a small metal footprint.
