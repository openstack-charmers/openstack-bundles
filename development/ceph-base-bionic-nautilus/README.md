...
*DEV/TEST ONLY*: This unstable, development example bundle deploys a Ceph (Nautilus) cluster on Ubuntu 18.04 LTS. See also: [Stable Bundles](https://jujucharms.com/u/openstack-charmers).
