...
This example bundle deploys a basic OpenStack Cloud (Rocky with Ceph Mimic) on Ubuntu 18.10 (Cosmic), providing Dashboard, Compute, Network, Block Storage, Object Storage, Identity and Image services.
