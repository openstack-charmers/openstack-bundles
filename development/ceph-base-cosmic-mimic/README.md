...
*DEV/TEST ONLY*: This unstable, development example bundle deploys a Ceph (Mimic) cluster on Ubuntu 18.10. See also: [Stable Bundles](https://jujucharms.com/u/openstack-charmers).
